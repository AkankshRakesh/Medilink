...
const handleChange = (e) => {
  ...
  return (
    <div className='flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16 py-4 md:py-0 md:mx-32 mx-4'>
            <h4 className={'text-5xl text-white sm:text-6xl md:text-7xl text-center mt-10 md:mt-20 '}>
