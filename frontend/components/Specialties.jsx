...
const Specialties = () => {
  ...
  return (
    <div className="p-6 xl:mx-12 dark:bg-gray-900">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-12 mt-4 gap-2">
...
const SpecialtyCard = ({ specialty }) => {
  return (
    ...
    >
      ...
      <span className="text-center text-xs md:text-sm xl:text-md font-medium text-gray-800 dark:text-gray-100">
        {specialty.shortName}
      </span>
    </Link>
  )
